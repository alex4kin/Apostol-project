...
!(function (n) {
  ...
  ((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs) ||
    ...
    u.define("select2/results", ["jquery", "./utils"], function (u, d) {
      ...
      return (
        ...
        (s.prototype.append = function (e) {
          this.hideLoading();
          var t = [];
          if (null == e.results || 0 === e.results.length) 0 === this.$results.children().length && this.trigger("results:message", { message: "noResults" });
          else {
        ...
        (s.prototype.option = function (e) {
          var t,
            ...
            s = (n.classList.add("select2-results__option"), n.classList.add("select2-results__option--selectable"), { role: "option" }),
            i = window.Element.prototype.matches || window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector;
          for (t in (((null != e.element && i.call(e.element, ":disabled")) || (null == e.element && e.disabled)) && ((s["aria-disabled"] = "true"), n.classList.remove("select2-results__option--selectable"), n.classList.add("select2-results__option--disabled")),
          null == e.id && n.classList.remove("select2-results__option--selectable"),
          null != e._resultId && (n.id = e._resultId),
          e.title && (n.title = e.title),
          e.children && ((s.role = "group"), (s["aria-label"] = e.text), n.classList.remove("select2-results__option--selectable"), n.classList.add("select2-results__option--group")),
          s))
          ...
          if (e.children) {
            ...
            var c = u("<ul></ul>", { class: "select2-results__options select2-results__options--nested", role: "none" });
        ...
        (s.prototype.bind = function (t, e) {
          ...
          this.$results.attr("id", n),
            ...
            t.on("results:select", function () {
              ...
              0 !== t.length && ((e = d.GetData(t[0], "data")), t.hasClass("select2-results__option--selected") ? i.trigger("close", {}) : i.trigger("select", { data: e }));
            }),
            ...
            this.$results.on("mouseup", ".select2-results__option--selectable", function (e) {
              ...
              t.hasClass("select2-results__option--selected") ? (i.options.get("multiple") ? i.trigger("unselect", { originalEvent: e, data: n }) : i.trigger("close", { originalEvent: e, data: n })) : i.trigger("select", { originalEvent: e, data: n });
            }),
            this.$results.on("mouseenter", ".select2-results__option--selectable", function (e) {
              var t = d.GetData(this, "data");
              i.getHighlightedResults().removeClass("select2-results__option--highlighted").attr("aria-selected", "false"), i.trigger("results:focus", { data: t, element: u(this) });
            });
        }),
    ...
    u.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function (e, t, n, s) {
      ...
      return (
        ...
        (i.prototype.render = function () {
          ...
          return e[0].classList.add("select2-selection--single"), e.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"><i class="bi bi-chevron-down"></i></b></span>'), e;
        }),
        ...
        (e.prototype.update = function (e, t) {
          ...
          e.call(this, t),
            ...
            0 < this.$selection.find(".select2-selection__placeholder").length ||
              0 === t.length ||
              ((e = this.$selection.find(".select2-selection__rendered").attr("id")),
              (n = this.options.get("translations").get("removeAllItems")),
              (s = i('<button type="button" class="select2-selection__clear" tabindex="-1"><span aria-hidden="true">&times;</span></button>')).attr("title", n()),
              s.attr("aria-label", n()),
      ...
      return (
        (e.prototype.bind = function (e, t, n) {
          ...
          e.call(this, t, n),
            t.on("*", function (e, t) {
              var n;
              -1 !== i.indexOf(e) && ((n = r.Event("select2:" + e, { params: (t = t || {}) })), s.$element.trigger(n), -1 !== o.indexOf(e)) && (t.prevented = n.isDefaultPrevented());
            });
        }),
        e
      );
      ...
      return (
        ...
        (n.prototype.select = function (i) {
          ...
          (i.selected = !0),
            null != i.element && "option" === i.element.tagName.toLowerCase()
              ? ((i.element.selected = !0), this.$element.trigger("input").trigger("change"))
        ...
        (n.prototype.unselect = function (i) {
          ...
          this.$element.prop("multiple") &&
            ((i.selected = !1),
            null != i.element && "option" === i.element.tagName.toLowerCase()
              ? ((i.element.selected = !1), this.$element.trigger("input").trigger("change"))
              : this.current(function (e) {
        ...
        (n.prototype.item = function (e) {
          ...
          if (null == (t = a.GetData(e[0], "data"))) {
            ...
            if ("option" === n.tagName.toLowerCase()) t = { id: e.val(), text: e.text(), disabled: e.prop("disabled"), selected: e.prop("selected"), title: e.prop("title") };
              ...
              for (var t = { text: e.prop("label"), children: [], title: e.prop("title") }, s = e.children("option"), i = [], o = 0; o < s.length; o++) {
                var r = l(s[o]),
                  r = this.item(r);
                i.push(r);
              }
        ...
        (n.prototype._normalizeItem = function (e) {
          ...
          return (
            null != (e = l.extend({}, { text: "" }, e)).id && (e.id = e.id.toString()), null != e.text && (e.text = e.text.toString()), null == e._resultId && e.id && null != this.container && (e._resultId = this.generateResultId(this.container, e)), l.extend({}, { selected: !1, disabled: !1 }, e)
          );
        }),
          ...
          for (var o = 0; o < e.length; o++) {
            ...
            0 <= s.indexOf(l.id)
              ? ((r = n.filter(
                ...
                (a = this.option(a)),
                r.replaceWith(a))
              : ((r = this.option(l)), l.children && ((a = this.convertToOptions(l.children)), r.append(a)), i.push(r));
          }
          return i;
        }),
        s
    ...
    u.define("select2/data/ajax", ["./array", "../utils", "jquery"], function (e, t, o) {
      ...
      return (
        ...
        (n.prototype.query = function (t, n) {
          var s = this,
            i = (null != this._request && ("function" == typeof this._request.abort && this._request.abort(), (this._request = null)), o.extend({ type: "GET" }, this.ajaxOptions));
          function e() {
            var e = i.transport(
              i,
              function (e) {
              ...
              function () {
                (e && "status" in e && (0 === e.status || "0" === e.status)) || s.trigger("results:message", { message: "errorLoading" });
              }
            );
            s._request = e;
          }
      ...
      return (
        ...
        (e.prototype.query = function (e, t, n) {
          ...
          var i = this.tokenizer(t, this.options, function (e) {
            ...
            }).length || ((e = s.option(t)).attr("data-select2-tag", !0), s._removeOldTags(), s.addOptions([e])),
        ...
        (e.prototype.tokenizer = function (e, t, n, s) {
          for (
            ...
            var l = o[r];
            -1 === i.indexOf(l) ? r++ : ((l = o.substr(0, r)), null == (l = a(c.extend({}, t, { term: l }))) ? r++ : (s(l), (o = o.substr(r + 1) || ""), (r = 0)));
          }
          return { term: o };
        }),
        e
      ...
      return (
        ...
        (e.prototype._positionDropdown = function () {
          var e = u(window),
            ...
            o = ((i.bottom = i.top + this.$container.outerHeight(!1)), { height: this.$container.outerHeight(!1) });
          ...
          (u.contains(document.body, l[0]) || l[0].isConnected) && (c = l.offset()),
            (i.top -= c.top),
            (i.left -= c.left),
            t || n || (s = "below"),
            e || !a || t ? !a && e && t && (s = "below") : (s = "above"),
            ("above" == s || (t && "below" !== s)) && (i.top = o.top - c.top - r),
            null != s &&
    ...
    u.define("select2/dropdown/selectOnClose", ["../utils"], function (n) {
      ...
      return (
        ...
        (e.prototype._handleSelectOnClose = function (e, t) {
          ...
          t.length < 1 || (null != (t = n.GetData(t[0], "data")).element && t.element.selected) || (null == t.element && t.selected) || this.trigger("select", { data: t });
        }),
        e
      );
    }),
    ...
    u.define(
      ...
      function (l, o, r, a, c, u, d, p, h, f, g, t, m, y, v, _, b, w, $, x, A, D, S, O, L, E, C, T, q, I, e) {
        function n() {
          this.reset();
        }
        return (
          (n.prototype.apply = function (e) {
            null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter &&
              ...
              0 < e.minimumInputLength && (e.dataAdapter = f.Decorate(e.dataAdapter, w)),
              ...
              null == e.resultsAdapter &&
                ((e.resultsAdapter = o), null != e.ajax && (e.resultsAdapter = f.Decorate(e.resultsAdapter, O)), null != e.placeholder && (e.resultsAdapter = f.Decorate(e.resultsAdapter, S)), e.selectOnClose && (e.resultsAdapter = f.Decorate(e.resultsAdapter, C)), e.tags) &&
                (e.resultsAdapter = f.Decorate(e.resultsAdapter, I)),
              null == e.dropdownAdapter &&
                (e.multiple ? (e.dropdownAdapter = A) : ((t = f.Decorate(A, D)), (e.dropdownAdapter = t)),
                0 !== e.minimumResultsForSearch && (e.dropdownAdapter = f.Decorate(e.dropdownAdapter, E)),
    ...
    (i = function (c) {
      ...
      function s(e) {
        ...
        if (
          ...
          "axis" in n && n.axis === n.HORIZONTAL_AXIS && ((o = -1 * r), (r = 0)),
          (i = 0 === r ? o : r),
          ...
          return (
            1 === n.deltaMode ? ((i *= t = c.data(this, "mousewheel-line-height")), (r *= t), (o *= t)) : 2 === n.deltaMode && ((i *= t = c.data(this, "mousewheel-page-height")), (r *= t), (o *= t)),
            ...
            h.settings.normalizeOffset && this.getBoundingClientRect && ((n = this.getBoundingClientRect()), (a = e.clientX - n.left), (l = e.clientY - n.top)),
            (e.deltaX = o),
            (e.deltaY = r),
            (e.deltaFactor = d),
            (e.offsetX = a),
    ...
    "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], i) : "object" == typeof exports ? (module.exports = i) : i(t),
